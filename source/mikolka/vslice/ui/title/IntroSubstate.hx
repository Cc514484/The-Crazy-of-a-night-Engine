...
class IntroSubstate extends MusicBeatSubstate
{
    ...
    override function create() {
		...
		{
			ngSpr.loadGraphic(Paths.image('Yasa_logo_classic'));
		}
		else
		{
			ngSpr.loadGraphic(Paths.image('Yasa_logo'));
	...
	override function beatHit()
	{
		...
		switch (sickBeats)
		{
			...
			case 2:
				createCoolText(['Funkin Crew Inc', 'Shadow Mario', 'mikolka9144','Team Tfunk']);
			case 4:
				addMoreText('');
			case 5:
				deleteCoolText();
			case 6:
				createCoolText(['Mow Engine made', 'By'], -40);
			case 8:
				addMoreText('Yasa', -40);
				ngSpr.visible = true;
			case 9:
